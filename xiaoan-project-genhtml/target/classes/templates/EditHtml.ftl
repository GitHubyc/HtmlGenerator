                                ...
                                <#list model_column?keys as key>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                            <input name="${model_column[key].ChangeColumnName}" class="form-control" th:value="${r"$"}{object.data.${model_column[key].ChangeColumnName}} == null?'':${r"$"}{object.data.${model_column[key].ChangeColumnName}}"
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="item form-group">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        <textarea class="form-control" name="${modelName?uncap_first}Details" th:text="${r"$"}{object.data.${modelName?uncap_first}Details}"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
