                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                            <input class="form-control" disabled="disabled"
                                                   th:value="${r"$"}{object.data.${model_column[key].ChangeColumnName}} == null or object.data.${model_column[key].ChangeColumnName}} == 'null'?'':${r"$"}{object.data.${model_column[key].ChangeColumnName}}"/>
                                        </div>
                                    </div>
                                </#list>
                            </div>
